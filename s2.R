...
#> summary(unlist(lapply(pattern3, length)))
#Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#7.000   7.000   7.000   7.333   7.500   8.000 

pattern3<-sapply(draw_pattern, function(x)patternV[[x]])
...
scenario_out<-simulation(N=1000, phi_v=phi_1, 
                         ...
                         prob_pattern=rep(1/3, 3), R=50000)

save(scenario_out, file="~/scenario_B.RData")  
warnings()
